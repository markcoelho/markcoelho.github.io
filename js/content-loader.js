                ...
                if (item.controls === "true") {
                    ...
                    const imageControls = this.createGeneralControls({
                        ...
                        buttons: [
                            ...
                            { src: 'right.png', class: 'scroller', position: '0.2 0 0.1', direction: 'right' },
                            { src: 'down.png', class: 'scroller', position: '0 -0.1 0.1', direction: 'down' },
                            { src: 'left.png', class: 'scroller', position: '-0.2 0 0.1', direction: 'left' },
                            { src: 'zoom-in.png', class: 'zoom-button', position: '0.5 0 0.1', action: 'increase', fuseTimeout: 500 },
                            { src: 'zoom-out.png', class: 'zoom-button', position: '0.7 0 0.1', action: 'decrease', fuseTimeout: 500 }
                        ]
                    });
                ...
                if (item.controls === "true") {
                    ...
                    const modelControls = this.createGeneralControls({
                        ...
                        buttons: [
                            ...
                            { src: 'right.png', class: 'roller', position: '0.2 0 0.1', direction: 'right' },
                            { src: 'down.png', class: 'roller', position: '0 -0.1 0.1', direction: 'down' },
                            { src: 'left.png', class: 'roller', position: '-0.2 0 0.1', direction: 'left' },
                            { src: 'zoom-in.png', class: 'model-zoom-button', position: '0.5 0 0.1', action: '3dincrease', fuseTimeout: 500 },
                            { src: 'zoom-out.png', class: 'model-zoom-button', position: '0.7 0 0.1', action: '3ddecrease', fuseTimeout: 500 }
                        ]
                    });
                ...
                case 'image':
                    ...
                    if (item.controls === "true") {
                        ...
                        const imageControls = this.createGeneralControls({
                            ...
                            type: 'marker-image',
                            buttons: [
                                { src: 'reset.png', class: 'marker-reset', position: '-0.7 0 0.1', action: 'markerReset', fuseTimeout: 1000 },
                                { src: 'up.png', class: 'marker-scroller', position: '0 0.1 0.1', direction: 'up' },
                                { src: 'right.png', class: 'marker-scroller', position: '0.2 0 0.1', direction: 'right' },
                                { src: 'down.png', class: 'marker-scroller', position: '0 -0.1 0.1', direction: 'down' },
                                { src: 'left.png', class: 'marker-scroller', position: '-0.2 0 0.1', direction: 'left' },
                                { src: 'zoom-in.png', class: 'marker-zoom-button', position: '0.5 0 0.1', action: 'markerIncrease', fuseTimeout: 500 },
                                { src: 'zoom-out.png', class: 'marker-zoom-button', position: '0.7 0 0.1', action: 'markerDecrease', fuseTimeout: 500 }
                            ]
                        });
                ...
                case '3d':
                    ...
                    if (item.controls === "true") {
                        ...
                        const modelControls = this.createGeneralControls({
                            ...
                            type: 'marker-3d',
                            buttons: [
                                { src: 'reset.png', class: 'marker-3dreset', position: '-0.7 0 0.1', action: 'marker3dreset', fuseTimeout: 1000 },
                                { src: 'up.png', class: 'marker-roller', position: '0 0.1 0.1', direction: 'up' },
                                { src: 'right.png', class: 'marker-roller', position: '0.2 0 0.1', direction: 'right' },
                                { src: 'down.png', class: 'marker-roller', position: '0 -0.1 0.1', direction: 'down' },
                                { src: 'left.png', class: 'marker-roller', position: '-0.2 0 0.1', direction: 'left' },
                                { src: 'zoom-in.png', class: 'marker-model-zoom-button', position: '0.5 0 0.1', action: 'marker3dincrease', fuseTimeout: 500 },
                                { src: 'zoom-out.png', class: 'marker-model-zoom-button', position: '0.7 0 0.1', action: 'marker3ddecrease', fuseTimeout: 500 }
                            ]
                        });
